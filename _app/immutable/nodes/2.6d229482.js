import{K as Fi,S as xr,i as Rr,s as Mr,k as J,q as bt,a as me,l as Z,m as it,r as kt,h as O,c as ye,n as st,b as Dt,H as V,L as Vi,M as Un,I as Ge,N as jo,O as qo,u as Cu,p as _n,d as Bn,f as Au,g as jn,v as _u,y as zo,z as Ho,A as Ko,P as Go,Q as qn,B as Qo}from"../chunks/index.faab397e.js";function Du(e){const t=e-1;return t*t*t+1}function zn(e,{delay:t=0,duration:n=400,easing:s=Du,x:r=0,y:i=0,opacity:o=0}={}){const a=getComputedStyle(e),c=+a.opacity,u=a.transform==="none"?"":a.transform,h=c*(1-o),[l,d]=Fi(r),[f,y]=Fi(i);return{delay:t,duration:n,easing:s,css:(v,I)=>`
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rr="[DEFAULT]",Fh={[sr]:"fire-core",[dh]:"fire-core-compat",[gh]:"fire-analytics",[fh]:"fire-analytics-compat",[mh]:"fire-app-check",[ph]:"fire-app-check-compat",[yh]:"fire-auth",[vh]:"fire-auth-compat",[wh]:"fire-rtdb",[Eh]:"fire-rtdb-compat",[Th]:"fire-fn",[Ih]:"fire-fn-compat",[Sh]:"fire-iid",[Ch]:"fire-iid-compat",[Ah]:"fire-fcm",[_h]:"fire-fcm-compat",[Dh]:"fire-perf",[bh]:"fire-perf-compat",[kh]:"fire-rc",[Nh]:"fire-rc-compat",[xh]:"fire-gcs",[Rh]:"fire-gcs-compat",[Mh]:"fire-fst",[Oh]:"fire-fst-compat","fire-js":"fire-js",[Lh]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function En(e){if(e.code!==g.FAILED_PRECONDITION||e.message!==vd)throw e;w("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gt{constructor(t){this.fields=t,t.sort(at.comparator)}static empty(){return new gt([])}unionWith(t){let n=new ht(at.comparator);for(const s of this.fields)n=n.add(s);for(const s of t)n=n.add(s);return new gt(n.toArray())}covers(t){for(const n of this.fields)if(n.isPrefixOf(t))return!0;return!1}isEqual(t){return Ee(this.fields,t.fields,(n,s)=>n.isEqual(s))}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xf{constructor(t){this.serializer=t,this.cs=new Map,this.hs=new Map}getBundleMetadata(t,n){return p.resolve(this.cs.get(n))}saveBundleMetadata(t,n){var s;return this.cs.set(n.id,{id:(s=n).id,version:s.version,createTime:Ct(s.createTime)}),p.resolve()}getNamedQuery(t,n){return p.resolve(this.hs.get(n))}saveNamedQuery(t,n){return this.hs.set(n.name,function(s){return{name:s.name,query:Af(s.bundledQuery),readTime:Ct(s.readTime)}}(n)),p.resolve()}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rf{constructor(){this.overlays=new $(T.comparator),this.ls=new Map}getOverlay(t,n){return p.resolve(this.overlays.get(n))}getOverlays(t,n){const s=Xt();return p.forEach(n,r=>this.getOverlay(t,r).next(i=>{i!==null&&s.set(r,i)})).next(()=>s)}saveOverlays(t,n,s){return s.forEach((r,i)=>{this.we(t,n,i)}),p.resolve()}removeOverlaysForBatchId(t,n,s){const r=this.ls.get(s);return r!==void 0&&(r.forEach(i=>this.overlays=this.overlays.remove(i)),this.ls.delete(s)),p.resolve()}getOverlaysForCollection(t,n,s){const r=Xt(),i=n.length+1,o=new T(n.child("")),a=this.overlays.getIteratorFrom(o);for(;a.hasNext();){const c=a.getNext().value,u=c.getKey();if(!n.isPrefixOf(u.path))break;u.path.length===i&&c.largestBatchId>s&&r.set(c.getKey(),c)}return p.resolve(r)}getOverlaysForCollectionGroup(t,n,s,r){let i=new $((u,h)=>u-h);const o=this.overlays.getIterator();for(;o.hasNext();){const u=o.getNext().value;if(u.getKey().getCollectionGroup()===n&&u.largestBatchId>s){let h=i.get(u.largestBatchId);h===null&&(h=Xt(),i=i.insert(u.largestBatchId,h)),h.set(u.getKey(),u)}}const a=Xt(),c=i.getIterator();for(;c.hasNext()&&(c.getNext().value.forEach((u,h)=>a.set(u,h)),!(a.size()>=r)););return p.resolve(a)}we(t,n,s){const r=this.overlays.get(s.key);if(r!==null){const o=this.ls.get(r.largestBatchId).delete(s.key);this.ls.set(r.largestBatchId,o)}this.overlays=this.overlays.insert(s.key,new tf(n,s));let i=this.ls.get(n);i===void 0&&(i=D(),this.ls.set(n,i)),this.ls.set(n,i.add(s.key))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mf{constructor(t,n){this.indexManager=t,this.referenceDelegate=n,this.mutationQueue=[],this.vs=1,this.Rs=new ht(K.ds)}checkEmpty(t){return p.resolve(this.mutationQueue.length===0)}addMutationBatch(t,n,s,r){const i=this.vs;this.vs++,this.mutationQueue.length>0&&this.mutationQueue[this.mutationQueue.length-1];const o=new Zd(i,n,s,r);this.mutationQueue.push(o);for(const a of r)this.Rs=this.Rs.add(new K(a.key,i)),this.indexManager.addToCollectionParentIndex(t,a.key.path.popLast());return p.resolve(o)}lookupMutationBatch(t,n){return p.resolve(this.Ps(n))}getNextMutationBatchAfterBatchId(t,n){const s=n+1,r=this.bs(s),i=r<0?0:r;return p.resolve(this.mutationQueue.length>i?this.mutationQueue[i]:null)}getHighestUnacknowledgedBatchId(){return p.resolve(this.mutationQueue.length===0?-1:this.vs-1)}getAllMutationBatches(t){return p.resolve(this.mutationQueue.slice())}getAllMutationBatchesAffectingDocumentKey(t,n){const s=new K(n,0),r=new K(n,Number.POSITIVE_INFINITY),i=[];return this.Rs.forEachInRange([s,r],o=>{const a=this.Ps(o.As);i.push(a)}),p.resolve(i)}getAllMutationBatchesAffectingDocumentKeys(t,n){let s=new ht(k);return n.forEach(r=>{const i=new K(r,0),o=new K(r,Number.POSITIVE_INFINITY);this.Rs.forEachInRange([i,o],a=>{s=s.add(a.As)})}),p.resolve(this.Vs(s))}getAllMutationBatchesAffectingQuery(t,n){const s=n.path,r=s.length+1;let i=s;T.isDocumentKey(i)||(i=i.child(""));const o=new K(new T(i),0);let a=new ht(k);return this.Rs.forEachWhile(c=>{const u=c.key.path;return!!s.isPrefixOf(u)&&(u.length===r&&(a=a.add(c.As)),!0)},o),p.resolve(this.Vs(a))}Vs(t){const n=[];return t.forEach(s=>{const r=this.Ps(s);r!==null&&n.push(r)}),n}removeMutationBatch(t,n){P(this.Ss(n.batchId,"removed")===0),this.mutationQueue.shift();let s=this.Rs;return p.forEach(n.mutations,r=>{const i=new K(r.key,n.batchId);return s=s.delete(i),this.referenceDelegate.markPotentiallyOrphaned(t,r.key)}).next(()=>{this.Rs=s})}Cn(t){}containsKey(t,n){const s=new K(n,0),r=this.Rs.firstAfterOrEqual(s);return p.resolve(n.isEqual(r&&r.key))}performConsistencyCheck(t){return this.mutationQueue.length,p.resolve()}Ss(t,n){return this.bs(t)}bs(t){return this.mutationQueue.length===0?0:t-this.mutationQueue[0].batchId}Ps(t){const n=this.bs(t);return n<0||n>=this.mutationQueue.length?null:this.mutationQueue[n]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class eg extends class{}{constructor(t,n,s,r){super(),this.authCredentials=t,this.appCheckCredentials=n,this.connection=s,this.serializer=r,this.lu=!1}fu(){if(this.lu)throw new E(g.FAILED_PRECONDITION,"The client has already been terminated.")}Io(t,n,s){return this.fu(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([r,i])=>this.connection.Io(t,n,s,r,i)).catch(r=>{throw r.name==="FirebaseError"?(r.code===g.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),r):new E(g.UNKNOWN,r.toString())})}vo(t,n,s,r){return this.fu(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([i,o])=>this.connection.vo(t,n,s,i,o,r)).catch(i=>{throw i.name==="FirebaseError"?(i.code===g.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),i):new E(g.UNKNOWN,i.toString())})}terminate(){this.lu=!0}}class ng{constructor(t,n){this.asyncQueue=t,this.onlineStateHandler=n,this.state="Unknown",this.wu=0,this._u=null,this.mu=!0}gu(){this.wu===0&&(this.yu("Unknown"),this._u=this.asyncQueue.enqueueAfterDelay("online_state_timeout",1e4,()=>(this._u=null,this.pu("Backend didn't respond within 10 seconds."),this.yu("Offline"),Promise.resolve())))}Iu(t){this.state==="Online"?this.yu("Unknown"):(this.wu++,this.wu>=1&&(this.Tu(),this.pu(`Connection failed 1 times. Most recent error: ${t.toString()}`),this.yu("Offline")))}set(t){this.Tu(),this.wu=0,t==="Online"&&(this.mu=!1),this.yu(t)}yu(t){t!==this.state&&(this.state=t,this.onlineStateHandler(t))}pu(t){const n=`Could not reach Cloud Firestore backend. ${t}
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sg{constructor(t,n,s,r,i){this.localStore=t,this.datastore=n,this.asyncQueue=s,this.remoteSyncer={},this.Eu=[],this.Au=new Map,this.vu=new Set,this.Ru=[],this.Pu=i,this.Pu.Yr(o=>{s.enqueueAndForget(async()=>{ie(this)&&(w("RemoteStore","Restarting streams for network reachability change."),await async function(a){const c=_(a);c.vu.add(4),await Cn(c),c.bu.set("Unknown"),c.vu.delete(4),await xs(c)}(this))})}),this.bu=new ng(s,r)}}async function xs(e){if(ie(e))for(const t of e.Ru)await t(!0)}async function Cn(e){for(const t of e.Ru)await t(!1)}function Hc(e,t){const n=_(e);n.Au.has(t.targetId)||(n.Au.set(t.targetId,t),Ti(n)?Ei(n):xe(n).Ko()&&wi(n,t))}function Kc(e,t){const n=_(e),s=xe(n);n.Au.delete(t),s.Ko()&&Gc(n,t),n.Au.size===0&&(s.Ko()?s.jo():ie(n)&&n.bu.set("Unknown"))}function wi(e,t){if(e.Vu.qt(t.targetId),t.resumeToken.approximateByteSize()>0||t.snapshotVersion.compareTo(A.min())>0){const n=e.remoteSyncer.getRemoteKeysForTarget(t.targetId).size;t=t.withExpectedCount(n)}xe(e).su(t)}function Gc(e,t){e.Vu.qt(t),xe(e).iu(t)}function Ei(e){e.Vu=new of({getRemoteKeysForTarget:t=>e.remoteSyncer.getRemoteKeysForTarget(t),le:t=>e.Au.get(t)||null,ue:()=>e.datastore.serializer.databaseId}),xe(e).start(),e.bu.gu()}function Ti(e){return ie(e)&&!xe(e).Uo()&&e.Au.size>0}function ie(e){return _(e).vu.size===0}function Qc(e){e.Vu=void 0}async function rg(e){e.Au.forEach((t,n)=>{wi(e,t)})}async function ig(e,t){Qc(e),Ti(e)?(e.bu.Iu(t),Ei(e)):e.bu.set("Unknown")}async function og(e,t,n){if(e.bu.set("Online"),t instanceof Oc&&t.state===2&&t.cause)try{await async function(s,r){const i=r.cause;for(const o of r.targetIds)s.Au.has(o)&&(await s.remoteSyncer.rejectListen(o,i),s.Au.delete(o),s.Vu.removeTarget(o))}(e,t)}catch(s){w("RemoteStore","Failed to remove targets %s: %s ",t.targetIds.join(","),s),await os(e,s)}else if(t instanceof Vn?e.Vu.Ht(t):t instanceof Mc?e.Vu.ne(t):e.Vu.Xt(t),!n.isEqual(A.min()))try{const s=await jc(e.localStore);n.compareTo(s)>=0&&await function(r,i){const o=r.Vu.ce(i);return o.targetChanges.forEach((a,c)=>{if(a.resumeToken.approximateByteSize()>0){const u=r.Au.get(c);u&&r.Au.set(c,u.withResumeToken(a.resumeToken,i))}}),o.targetMismatches.forEach((a,c)=>{const u=r.Au.get(a);if(!u)return;r.Au.set(a,u.withResumeToken(lt.EMPTY_BYTE_STRING,u.snapshotVersion)),Gc(r,a);const h=new Ft(u.target,a,c,u.sequenceNumber);wi(r,h)}),r.remoteSyncer.applyRemoteEvent(o)}(e,n)}catch(s){w("RemoteStore","Failed to raise snapshot:",s),await os(e,s)}}async function os(e,t,n){if(!Tn(t))throw t;e.vu.add(1),await Cn(e),e.bu.set("Offline"),n||(n=()=>jc(e.localStore)),e.asyncQueue.enqueueRetryable(async()=>{w("RemoteStore","Retrying IndexedDB access"),await n(),e.vu.delete(1),await xs(e)})}function Wc(e,t){return t().catch(n=>os(e,n,t))}async function Rs(e){const t=_(e),n=zt(t);let s=t.Eu.length>0?t.Eu[t.Eu.length-1].batchId:-1;for(;ag(t);)try{const r=await Hf(t.localStore,s);if(r===null){t.Eu.length===0&&n.jo();break}s=r.batchId,cg(t,r)}catch(r){await os(t,r)}Yc(t)&&Xc(t)}function ag(e){return ie(e)&&e.Eu.length<10}function cg(e,t){e.Eu.push(t);const n=zt(e);n.Ko()&&n.ou&&n.uu(t.mutations)}function Yc(e){return ie(e)&&!zt(e).Uo()&&e.Eu.length>0}function Xc(e){zt(e).start()}async function ug(e){zt(e).hu()}async function hg(e){const t=zt(e);for(const n of e.Eu)t.uu(n.mutations)}async function lg(e,t,n){const s=e.Eu.shift(),r=di.from(s,t,n);await Wc(e,()=>e.remoteSyncer.applySuccessfulWrite(r)),await Rs(e)}async function dg(e,t){t&&zt(e).ou&&await async function(n,s){if(r=s.code,nf(r)&&r!==g.ABORTED){const i=n.Eu.shift();zt(n).Qo(),await Wc(n,()=>n.remoteSyncer.rejectFailedWrite(i.batchId,s)),await Rs(n)}var r}(e,t),Yc(e)&&Xc(e)}async function Ro(e,t){const n=_(e);n.asyncQueue.verifyOperationInProgress(),w("RemoteStore","RemoteStore received new credentials");const s=ie(n);n.vu.add(3),await Cn(n),s&&n.bu.set("Unknown"),await n.remoteSyncer.handleCredentialChange(t),n.vu.delete(3),await xs(n)}async function fg(e,t){const n=_(e);t?(n.vu.delete(2),await xs(n)):t||(n.vu.add(2),await Cn(n),n.bu.set("Unknown"))}function xe(e){return e.Su||(e.Su=function(t,n,s){const r=_(t);return r.fu(),new Zf(n,r.connection,r.authCredentials,r.appCheckCredentials,r.serializer,s)}(e.datastore,e.asyncQueue,{uo:rg.bind(null,e),ao:ig.bind(null,e),nu:og.bind(null,e)}),e.Ru.push(async t=>{t?(e.Su.Qo(),Ti(e)?Ei(e):e.bu.set("Unknown")):(await e.Su.stop(),Qc(e))})),e.Su}function zt(e){return e.Du||(e.Du=function(t,n,s){const r=_(t);return r.fu(),new tg(n,r.connection,r.authCredentials,r.appCheckCredentials,r.serializer,s)}(e.datastore,e.asyncQueue,{uo:ug.bind(null,e),ao:dg.bind(null,e),au:hg.bind(null,e),cu:lg.bind(null,e)}),e.Ru.push(async t=>{t?(e.Du.Qo(),await Rs(e)):(await e.Du.stop(),e.Eu.length>0&&(w("RemoteStore",`Stopping write stream with ${e.Eu.length} pending writes`),e.Eu=[]))})),e.Du}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pe{constructor(t){this.comparator=t?(n,s)=>t(n,s)||T.comparator(n.key,s.key):(n,s)=>T.comparator(n.key,s.key),this.keyedMap=$e(),this.sortedSet=new $(this.comparator)}static emptySet(t){return new pe(t.comparator)}has(t){return this.keyedMap.get(t)!=null}get(t){return this.keyedMap.get(t)}first(){return this.sortedSet.minKey()}last(){return this.sortedSet.maxKey()}isEmpty(){return this.sortedSet.isEmpty()}indexOf(t){const n=this.keyedMap.get(t);return n?this.sortedSet.indexOf(n):-1}get size(){return this.sortedSet.size}forEach(t){this.sortedSet.inorderTraversal((n,s)=>(t(n),!1))}add(t){const n=this.delete(t.key);return n.copy(n.keyedMap.insert(t.key,t),n.sortedSet.insert(t,null))}delete(t){const n=this.get(t);return n?this.copy(this.keyedMap.remove(t),this.sortedSet.remove(n)):this}isEqual(t){if(!(t instanceof pe)||this.size!==t.size)return!1;const n=this.sortedSet.getIterator(),s=t.sortedSet.getIterator();for(;n.hasNext();){const r=n.getNext().key,i=s.getNext().key;if(!r.isEqual(i))return!1}return!0}toString(){const t=[];return this.forEach(n=>{t.push(n.toString())}),t.length===0?"DocumentSet ()":`DocumentSet (
  `+t.join(`  
`)+`
)`}copy(t,n){const s=new pe;return s.comparator=this.comparator,s.keyedMap=t,s.sortedSet=n,s}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class eu{constructor(t){this.key=t}}class nu{constructor(t){this.key=t}}class vg{constructor(t,n){this.query=t,this.Yu=n,this.Xu=null,this.hasCachedResults=!1,this.current=!1,this.Zu=D(),this.mutatedKeys=D(),this.tc=Ec(t),this.ec=new pe(this.tc)}get nc(){return this.Yu}sc(t,n){const s=n?n.ic:new Mo,r=n?n.ec:this.ec;let i=n?n.mutatedKeys:this.mutatedKeys,o=r,a=!1;const c=this.query.limitType==="F"&&r.size===this.query.limit?r.last():null,u=this.query.limitType==="L"&&r.size===this.query.limit?r.first():null;if(t.inorderTraversal((h,l)=>{const d=r.get(h),f=_s(this.query,l)?l:null,y=!!d&&this.mutatedKeys.has(d.key),v=!!f&&(f.hasLocalMutations||this.mutatedKeys.has(f.key)&&f.hasCommittedMutations);let I=!1;d&&f?d.data.isEqual(f.data)?y!==v&&(s.track({type:3,doc:f}),I=!0):this.rc(d,f)||(s.track({type:2,doc:f}),I=!0,(c&&this.tc(f,c)>0||u&&this.tc(f,u)<0)&&(a=!0)):!d&&f?(s.track({type:0,doc:f}),I=!0):d&&!f&&(s.track({type:1,doc:d}),I=!0,(c||u)&&(a=!0)),I&&(f?(o=o.add(f),i=v?i.add(h):i.delete(h)):(o=o.delete(h),i=i.delete(h)))}),this.query.limit!==null)for(;o.size>this.query.limit;){const h=this.query.limitType==="F"?o.last():o.first();o=o.delete(h.key),i=i.delete(h.key),s.track({type:1,doc:h})}return{ec:o,ic:s,zi:a,mutatedKeys:i}}rc(t,n){return t.hasLocalMutations&&n.hasCommittedMutations&&!n.hasLocalMutations}applyChanges(t,n,s){const r=this.ec;this.ec=t.ec,this.mutatedKeys=t.mutatedKeys;const i=t.ic.xu();i.sort((u,h)=>function(l,d){const f=y=>{switch(y){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return S()}};return f(l)-f(d)}(u.type,h.type)||this.tc(u.doc,h.doc)),this.oc(s);const o=n?this.uc():[],a=this.Zu.size===0&&this.current?1:0,c=a!==this.Xu;return this.Xu=a,i.length!==0||c?{snapshot:new Ce(this.query,t.ec,r,i,t.mutatedKeys,a===0,c,!1,!!s&&s.resumeToken.approximateByteSize()>0),cc:o}:{cc:o}}Mu(t){return this.current&&t==="Offline"?(this.current=!1,this.applyChanges({ec:this.ec,ic:new Mo,mutatedKeys:this.mutatedKeys,zi:!1},!1)):{cc:[]}}ac(t){return!this.Yu.has(t)&&!!this.ec.has(t)&&!this.ec.get(t).hasLocalMutations}oc(t){t&&(t.addedDocuments.forEach(n=>this.Yu=this.Yu.add(n)),t.modifiedDocuments.forEach(n=>{}),t.removedDocuments.forEach(n=>this.Yu=this.Yu.delete(n)),this.current=t.current)}uc(){if(!this.current)return[];const t=this.Zu;this.Zu=D(),this.ec.forEach(s=>{this.ac(s.key)&&(this.Zu=this.Zu.add(s.key))});const n=[];return t.forEach(s=>{this.Zu.has(s)||n.push(new nu(s))}),this.Zu.forEach(s=>{t.has(s)||n.push(new eu(s))}),n}hc(t){this.Yu=t.ir,this.Zu=D();const n=this.sc(t.documents);return this.applyChanges(n,!0)}lc(){return Ce.fromInitialDocuments(this.query,this.ec,this.mutatedKeys,this.Xu===0,this.hasCachedResults)}}class wg{constructor(t,n,s){this.query=t,this.targetId=n,this.view=s}}class Eg{constructor(t){this.key=t,this.fc=!1}}class Tg{constructor(t,n,s,r,i,o){this.localStore=t,this.remoteStore=n,this.eventManager=s,this.sharedClientState=r,this.currentUser=i,this.maxConcurrentLimboResolutions=o,this.dc={},this.wc=new Ne(a=>wc(a),As),this._c=new Map,this.mc=new Set,this.gc=new $(T.comparator),this.yc=new Map,this.Ic=new mi,this.Tc={},this.Ec=new Map,this.Ac=Se.Mn(),this.onlineState="Unknown",this.vc=void 0}get isPrimaryClient(){return this.vc===!0}}async function Ig(e,t){const n=Rg(e);let s,r;const i=n.wc.get(t);if(i)s=i.targetId,n.sharedClientState.addLocalQueryTarget(s),r=i.view.lc();else{const o=await Kf(n.localStore,Ot(t)),a=n.sharedClientState.addLocalQueryTarget(o.targetId);s=o.targetId,r=await Sg(n,t,s,a==="current",o.resumeToken),n.isPrimaryClient&&Hc(n.remoteStore,o)}return r}async function Sg(e,t,n,s,r){e.Rc=(l,d,f)=>async function(y,v,I,B){let R=v.view.sc(I);R.zi&&(R=await ko(y.localStore,v.query,!1).then(({documents:Y})=>v.view.sc(Y,R)));const W=B&&B.targetChanges.get(v.targetId),M=v.view.applyChanges(R,y.isPrimaryClient,W);return Lo(y,v.targetId,M.cc),M.snapshot}(e,l,d,f);const i=await ko(e.localStore,t,!0),o=new vg(t,i.ir),a=o.sc(i.documents),c=Sn.createSynthesizedTargetChangeForCurrentChange(n,s&&e.onlineState!=="Offline",r),u=o.applyChanges(a,e.isPrimaryClient,c);Lo(e,n,u.cc);const h=new wg(t,n,o);return e.wc.set(t,h),e._c.has(n)?e._c.get(n).push(t):e._c.set(n,[t]),u.snapshot}async function Cg(e,t){const n=_(e),s=n.wc.get(t),r=n._c.get(s.targetId);if(r.length>1)return n._c.set(s.targetId,r.filter(i=>!As(i,t))),void n.wc.delete(t);n.isPrimaryClient?(n.sharedClientState.removeLocalQueryTarget(s.targetId),n.sharedClientState.isActiveQueryTarget(s.targetId)||await br(n.localStore,s.targetId,!1).then(()=>{n.sharedClientState.clearQueryState(s.targetId),Kc(n.remoteStore,s.targetId),kr(n,s.targetId)}).catch(En)):(kr(n,s.targetId),await br(n.localStore,s.targetId,!0))}async function Ag(e,t,n){const s=Mg(e);try{const r=await function(i,o){const a=_(i),c=H.now(),u=o.reduce((d,f)=>d.add(f.key),D());let h,l;return a.persistence.runTransaction("Locally write mutations","readwrite",d=>{let f=Lt(),y=D();return a.Zi.getEntries(d,u).next(v=>{f=v,f.forEach((I,B)=>{B.isValidDocument()||(y=y.add(I))})}).next(()=>a.localDocuments.getOverlayedDocuments(d,f)).next(v=>{h=v;const I=[];for(const B of o){const R=Xd(B,h.get(B.key).overlayedDocument);R!=null&&I.push(new Gt(B.key,R,dc(R.value.mapValue),wt.exists(!0)))}return a.mutationQueue.addMutationBatch(d,c,I,o)}).next(v=>{l=v;const I=v.applyToLocalDocumentSet(h,y);return a.documentOverlayCache.saveOverlays(d,v.batchId,I)})}).then(()=>({batchId:l.batchId,changes:Ic(h)}))}(s.localStore,t);s.sharedClientState.addPendingMutation(r.batchId),function(i,o,a){let c=i.Tc[i.currentUser.toKey()];c||(c=new $(k)),c=c.insert(o,a),i.Tc[i.currentUser.toKey()]=c}(s,r.batchId,n),await An(s,r.changes),await Rs(s.remoteStore)}catch(r){const i=Si(r,"Failed to persist write");n.reject(i)}}async function su(e,t){const n=_(e);try{const s=await qf(n.localStore,t);t.targetChanges.forEach((r,i)=>{const o=n.yc.get(i);o&&(P(r.addedDocuments.size+r.modifiedDocuments.size+r.removedDocuments.size<=1),r.addedDocuments.size>0?o.fc=!0:r.modifiedDocuments.size>0?P(o.fc):r.removedDocuments.size>0&&(P(o.fc),o.fc=!1))}),await An(n,s,t)}catch(s){await En(s)}}function Oo(e,t,n){const s=_(e);if(s.isPrimaryClient&&n===0||!s.isPrimaryClient&&n===1){const r=[];s.wc.forEach((i,o)=>{const a=o.view.Mu(t);a.snapshot&&r.push(a.snapshot)}),function(i,o){const a=_(i);a.onlineState=o;let c=!1;a.queries.forEach((u,h)=>{for(const l of h.listeners)l.Mu(o)&&(c=!0)}),c&&Ci(a)}(s.eventManager,t),r.length&&s.dc.nu(r),s.onlineState=t,s.isPrimaryClient&&s.sharedClientState.setOnlineState(t)}}async function _g(e,t,n){const s=_(e);s.sharedClientState.updateQueryState(t,"rejected",n);const r=s.yc.get(t),i=r&&r.key;if(i){let o=new $(T.comparator);o=o.insert(i,ot.newNoDocument(i,A.min()));const a=D().add(i),c=new ks(A.min(),new Map,new $(k),o,a);await su(s,c),s.gc=s.gc.remove(i),s.yc.delete(t),Ai(s)}else await br(s.localStore,t,!1).then(()=>kr(s,t,n)).catch(En)}async function Dg(e,t){const n=_(e),s=t.batch.batchId;try{const r=await jf(n.localStore,t);iu(n,s,null),ru(n,s),n.sharedClientState.updateMutationState(s,"acknowledged"),await An(n,r)}catch(r){await En(r)}}async function bg(e,t,n){const s=_(e);try{const r=await function(i,o){const a=_(i);return a.persistence.runTransaction("Reject batch","readwrite-primary",c=>{let u;return a.mutationQueue.lookupMutationBatch(c,o).next(h=>(P(h!==null),u=h.keys(),a.mutationQueue.removeMutationBatch(c,h))).next(()=>a.mutationQueue.performConsistencyCheck(c)).next(()=>a.documentOverlayCache.removeOverlaysForBatchId(c,u,o)).next(()=>a.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(c,u)).next(()=>a.localDocuments.getDocuments(c,u))})}(s.localStore,t);iu(s,t,n),ru(s,t),s.sharedClientState.updateMutationState(t,"rejected",n),await An(s,r)}catch(r){await En(r)}}function ru(e,t){(e.Ec.get(t)||[]).forEach(n=>{n.resolve()}),e.Ec.delete(t)}function iu(e,t,n){const s=_(e);let r=s.Tc[s.currentUser.toKey()];if(r){const i=r.get(t);i&&(n?i.reject(n):i.resolve(),r=r.remove(t)),s.Tc[s.currentUser.toKey()]=r}}function kr(e,t,n=null){e.sharedClientState.removeLocalQueryTarget(t);for(const s of e._c.get(t))e.wc.delete(s),n&&e.dc.Pc(s,n);e._c.delete(t),e.isPrimaryClient&&e.Ic.Is(t).forEach(s=>{e.Ic.containsKey(s)||ou(e,s)})}function ou(e,t){e.mc.delete(t.path.canonicalString());const n=e.gc.get(t);n!==null&&(Kc(e.remoteStore,n),e.gc=e.gc.remove(t),e.yc.delete(n),Ai(e))}function Lo(e,t,n){for(const s of n)s instanceof eu?(e.Ic.addReference(s.key,t),kg(e,s)):s instanceof nu?(w("SyncEngine","Document no longer in limbo: "+s.key),e.Ic.removeReference(s.key,t),e.Ic.containsKey(s.key)||ou(e,s.key)):S()}function kg(e,t){const n=t.key,s=n.path.canonicalString();e.gc.get(n)||e.mc.has(s)||(w("SyncEngine","New document in limbo: "+n),e.mc.add(s),Ai(e))}function Ai(e){for(;e.mc.size>0&&e.gc.size<e.maxConcurrentLimboResolutions;){const t=e.mc.values().next().value;e.mc.delete(t);const n=new T(F.fromString(t)),s=e.Ac.next();e.yc.set(s,new Eg(n)),e.gc=e.gc.insert(n,s),Hc(e.remoteStore,new Ft(Ot(hi(n.path)),s,"TargetPurposeLimboResolution",ri.ct))}}async function An(e,t,n){const s=_(e),r=[],i=[],o=[];s.wc.isEmpty()||(s.wc.forEach((a,c)=>{o.push(s.Rc(c,t,n).then(u=>{if((u||n)&&s.isPrimaryClient&&s.sharedClientState.updateQueryState(c.targetId,u!=null&&u.fromCache?"not-current":"current"),u){r.push(u);const h=vi.Li(c.targetId,u);i.push(h)}}))}),await Promise.all(o),s.dc.nu(r),await async function(a,c){const u=_(a);try{await u.persistence.runTransaction("notifyLocalViewChanges","readwrite",h=>p.forEach(c,l=>p.forEach(l.Fi,d=>u.persistence.referenceDelegate.addReference(h,l.targetId,d)).next(()=>p.forEach(l.Bi,d=>u.persistence.referenceDelegate.removeReference(h,l.targetId,d)))))}catch(h){if(!Tn(h))throw h;w("LocalStore","Failed to update sequence numbers: "+h)}for(const h of c){const l=h.targetId;if(!h.fromCache){const d=u.Ji.get(l),f=d.snapshotVersion,y=d.withLastLimboFreeSnapshotVersion(f);u.Ji=u.Ji.insert(l,y)}}}(s.localStore,i))}async function Ng(e,t){const n=_(e);if(!n.currentUser.isEqual(t)){w("SyncEngine","User change. New user:",t.toKey());const s=await Bc(n.localStore,t);n.currentUser=t,function(r,i){r.Ec.forEach(o=>{o.forEach(a=>{a.reject(new E(g.CANCELLED,i))})}),r.Ec.clear()}(n,"'waitForPendingWrites' promise is rejected due to a user change."),n.sharedClientState.handleUserChange(t,s.removedBatchIds,s.addedBatchIds),await An(n,s.er)}}function xg(e,t){const n=_(e),s=n.yc.get(t);if(s&&s.fc)return D().add(s.key);{let r=D();const i=n._c.get(t);if(!i)return r;for(const o of i){const a=n.wc.get(o);r=r.unionWith(a.view.nc)}return r}}function Rg(e){const t=_(e);return t.remoteStore.remoteSyncer.applyRemoteEvent=su.bind(null,t),t.remoteStore.remoteSyncer.getRemoteKeysForTarget=xg.bind(null,t),t.remoteStore.remoteSyncer.rejectListen=_g.bind(null,t),t.dc.nu=mg.bind(null,t.eventManager),t.dc.Pc=yg.bind(null,t.eventManager),t}function Mg(e){const t=_(e);return t.remoteStore.remoteSyncer.applySuccessfulWrite=Dg.bind(null,t),t.remoteStore.remoteSyncer.rejectFailedWrite=bg.bind(null,t),t}class Po{constructor(){this.synchronizeTabs=!1}async initialize(t){this.serializer=Ns(t.databaseInfo.databaseId),this.sharedClientState=this.createSharedClientState(t),this.persistence=this.createPersistence(t),await this.persistence.start(),this.localStore=this.createLocalStore(t),this.gcScheduler=this.createGarbageCollectionScheduler(t,this.localStore),this.indexBackfillerScheduler=this.createIndexBackfillerScheduler(t,this.localStore)}createGarbageCollectionScheduler(t,n){return null}createIndexBackfillerScheduler(t,n){return null}createLocalStore(t){return Bf(this.persistence,new $f,t.initialUser,this.serializer)}createPersistence(t){return new Ff(yi.zs,this.serializer)}createSharedClientState(t){return new Qf}async terminate(){this.gcScheduler&&this.gcScheduler.stop(),await this.sharedClientState.shutdown(),await this.persistence.shutdown()}}class Og{async initialize(t,n){this.localStore||(this.localStore=t.localStore,this.sharedClientState=t.sharedClientState,this.datastore=this.createDatastore(n),this.remoteStore=this.createRemoteStore(n),this.eventManager=this.createEventManager(n),this.syncEngine=this.createSyncEngine(n,!t.synchronizeTabs),this.sharedClientState.onlineStateHandler=s=>Oo(this.syncEngine,s,1),this.remoteStore.remoteSyncer.handleCredentialChange=Ng.bind(null,this.syncEngine),await fg(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(t){return new pg}createDatastore(t){const n=Ns(t.databaseInfo.databaseId),s=(r=t.databaseInfo,new Jf(r));var r;return function(i,o,a,c){return new eg(i,o,a,c)}(t.authCredentials,t.appCheckCredentials,s,n)}createRemoteStore(t){return n=this.localStore,s=this.datastore,r=t.asyncQueue,i=a=>Oo(this.syncEngine,a,0),o=xo.D()?new xo:new Wf,new sg(n,s,r,i,o);var n,s,r,i,o}createSyncEngine(t,n){return function(s,r,i,o,a,c,u){const h=new Tg(s,r,i,o,a,c);return u&&(h.vc=!0),h}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,t.initialUser,t.maxConcurrentLimboResolutions,n)}terminate(){return async function(t){const n=_(t);w("RemoteStore","RemoteStore shutting down."),n.vu.add(5),await Cn(n),n.Pu.shutdown(),n.bu.set("Unknown")}(this.remoteStore)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pt{constructor(t,n,s){this.converter=n,this._key=s,this.type="document",this.firestore=t}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Ut(this.firestore,this.converter,this._key.path.popLast())}withConverter(t){return new pt(this.firestore,t,this._key)}}class Os{constructor(t,n,s){this.converter=n,this._query=s,this.type="query",this.firestore=t}withConverter(t){return new Os(this.firestore,t,this._query)}}class Ut extends Os{constructor(t,n,s){super(t,n,hi(s)),this._path=s,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const t=this._path.popLast();return t.isEmpty()?null:new pt(this.firestore,null,new T(t))}withConverter(t){return new Ut(this.firestore,t,this._path)}}function qg(e,t,...n){if(e=Bt(e),lu("collection","path",t),e instanceof Ms){const s=F.fromString(t,...n);return Uo(s),new Ut(e,null,s)}{if(!(e instanceof pt||e instanceof Ut))throw new E(g.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const s=e._path.child(F.fromString(t,...n));return Uo(s),new Ut(e.firestore,null,s)}}function du(e,t,...n){if(e=Bt(e),arguments.length===1&&(t=uc.A()),lu("doc","path",t),e instanceof Ms){const s=F.fromString(t,...n);return $o(s),new pt(e,null,new T(s))}{if(!(e instanceof pt||e instanceof Ut))throw new E(g.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const s=e._path.child(F.fromString(t,...n));return $o(s),new pt(e.firestore,e instanceof Ut?e.converter:null,new T(s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ae{constructor(t){this._byteString=t}static fromBase64String(t){try{return new Ae(lt.fromBase64String(t))}catch(n){throw new E(g.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+n)}}static fromUint8Array(t){return new Ae(lt.fromUint8Array(t))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(t){return this._byteString.isEqual(t._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ls{constructor(...t){for(let n=0;n<t.length;++n)if(t[n].length===0)throw new E(g.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new at(t)}isEqual(t){return this._internalPath.isEqual(t._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ki{constructor(t,n){if(!isFinite(t)||t<-90||t>90)throw new E(g.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+t);if(!isFinite(n)||n<-180||n>180)throw new E(g.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+n);this._lat=t,this._long=n}get latitude(){return this._lat}get longitude(){return this._long}isEqual(t){return this._lat===t._lat&&this._long===t._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(t){return k(this._lat,t._lat)||k(this._long,t._long)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Kg=/^__.*__$/;class Gg{constructor(t,n,s){this.data=t,this.fieldMask=n,this.fieldTransforms=s}toMutation(t,n){return this.fieldMask!==null?new Gt(t,this.data,this.fieldMask,n,this.fieldTransforms):new In(t,this.data,n,this.fieldTransforms)}}class gu{constructor(t,n,s){this.data=t,this.fieldMask=n,this.fieldTransforms=s}toMutation(t,n){return new Gt(t,this.data,this.fieldMask,n,this.fieldTransforms)}}function pu(e){switch(e){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw S()}}class Ni{constructor(t,n,s,r,i,o){this.settings=t,this.databaseId=n,this.serializer=s,this.ignoreUndefinedProperties=r,i===void 0&&this.ua(),this.fieldTransforms=i||[],this.fieldMask=o||[]}get path(){return this.settings.path}get ca(){return this.settings.ca}aa(t){return new Ni(Object.assign(Object.assign({},this.settings),t),this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}ha(t){var n;const s=(n=this.path)===null||n===void 0?void 0:n.child(t),r=this.aa({path:s,la:!1});return r.fa(t),r}da(t){var n;const s=(n=this.path)===null||n===void 0?void 0:n.child(t),r=this.aa({path:s,la:!1});return r.ua(),r}wa(t){return this.aa({path:void 0,la:!0})}_a(t){return as(t,this.settings.methodName,this.settings.ma||!1,this.path,this.settings.ga)}contains(t){return this.fieldMask.find(n=>t.isPrefixOf(n))!==void 0||this.fieldTransforms.find(n=>t.isPrefixOf(n.field))!==void 0}ua(){if(this.path)for(let t=0;t<this.path.length;t++)this.fa(this.path.get(t))}fa(t){if(t.length===0)throw this._a("Document fields must not be empty");if(pu(this.ca)&&Kg.test(t))throw this._a('Document fields cannot begin and end with "__"')}}class Qg{constructor(t,n,s){this.databaseId=t,this.ignoreUndefinedProperties=n,this.serializer=s||Ns(t)}ya(t,n,s,r=!1){return new Ni({ca:t,methodName:n,ga:s,path:at.emptyPath(),la:!1,ma:r},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function mu(e){const t=e._freezeSettings(),n=Ns(e._databaseId);return new Qg(e._databaseId,!!t.ignoreUndefinedProperties,n)}function Wg(e,t,n,s,r,i={}){const o=e.ya(i.merge||i.mergeFields?2:0,t,n,r);xi("Data must be an object, but it was:",o,s);const a=yu(s,o);let c,u;if(i.merge)c=new gt(o.fieldMask),u=o.fieldTransforms;else if(i.mergeFields){const h=[];for(const l of i.mergeFields){const d=Nr(t,l,n);if(!o.contains(d))throw new E(g.INVALID_ARGUMENT,`Field '${d}' is specified in your field mask but missing from your input data.`);wu(h,d)||h.push(d)}c=new gt(h),u=o.fieldTransforms.filter(l=>c.covers(l.field))}else c=null,u=o.fieldTransforms;return new Gg(new ft(a),c,u)}class Ps extends bi{_toFieldTransform(t){if(t.ca!==2)throw t.ca===1?t._a(`${this._methodName}() can only appear at the top level of your update data`):t._a(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return t.fieldMask.push(t.path),null}isEqual(t){return t instanceof Ps}}function Yg(e,t,n,s){const r=e.ya(1,t,n);xi("Data must be an object, but it was:",r,s);const i=[],o=ft.empty();re(s,(c,u)=>{const h=Ri(t,c,n);u=Bt(u);const l=r.da(h);if(u instanceof Ps)i.push(h);else{const d=Fs(u,l);d!=null&&(i.push(h),o.set(h,d))}});const a=new gt(i);return new gu(o,a,r.fieldTransforms)}function Xg(e,t,n,s,r,i){const o=e.ya(1,t,n),a=[Nr(t,s,n)],c=[r];if(i.length%2!=0)throw new E(g.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let d=0;d<i.length;d+=2)a.push(Nr(t,i[d])),c.push(i[d+1]);const u=[],h=ft.empty();for(let d=a.length-1;d>=0;--d)if(!wu(u,a[d])){const f=a[d];let y=c[d];y=Bt(y);const v=o.da(f);if(y instanceof Ps)u.push(f);else{const I=Fs(y,v);I!=null&&(u.push(f),h.set(f,I))}}const l=new gt(u);return new gu(h,l,o.fieldTransforms)}function Fs(e,t){if(vu(e=Bt(e)))return xi("Unsupported field value:",t,e),yu(e,t);if(e instanceof bi)return function(n,s){if(!pu(s.ca))throw s._a(`${n._methodName}() can only be used with update() and set()`);if(!s.path)throw s._a(`${n._methodName}() is not currently supported inside arrays`);const r=n._toFieldTransform(s);r&&s.fieldTransforms.push(r)}(e,t),null;if(e===void 0&&t.ignoreUndefinedProperties)return null;if(t.path&&t.fieldMask.push(t.path),e instanceof Array){if(t.settings.la&&t.ca!==4)throw t._a("Nested arrays are not supported");return function(n,s){const r=[];let i=0;for(const o of n){let a=Fs(o,s.wa(i));a==null&&(a={nullValue:"NULL_VALUE"}),r.push(a),i++}return{arrayValue:{values:r}}}(e,t)}return function(n,s){if((n=Bt(n))===null)return{nullValue:"NULL_VALUE"};if(typeof n=="number")return Hd(s.serializer,n);if(typeof n=="boolean")return{booleanValue:n};if(typeof n=="string")return{stringValue:n};if(n instanceof Date){const r=H.fromDate(n);return{timestampValue:is(s.serializer,r)}}if(n instanceof H){const r=new H(n.seconds,1e3*Math.floor(n.nanoseconds/1e3));return{timestampValue:is(s.serializer,r)}}if(n instanceof ki)return{geoPointValue:{latitude:n.latitude,longitude:n.longitude}};if(n instanceof Ae)return{bytesValue:Lc(s.serializer,n._byteString)};if(n instanceof pt){const r=s.databaseId,i=n.firestore._databaseId;if(!i.isEqual(r))throw s._a(`Document reference is for database ${i.projectId}/${i.database} but should be for database ${r.projectId}/${r.database}`);return{referenceValue:pi(n.firestore._databaseId||s.databaseId,n._key.path)}}throw s._a(`Unsupported field value: ${_i(n)}`)}(e,t)}function yu(e,t){const n={};return hc(e)?t.path&&t.path.length>0&&t.fieldMask.push(t.path):re(e,(s,r)=>{const i=Fs(r,t.ha(s));i!=null&&(n[s]=i)}),{mapValue:{fields:n}}}function vu(e){return!(typeof e!="object"||e===null||e instanceof Array||e instanceof Date||e instanceof H||e instanceof ki||e instanceof Ae||e instanceof pt||e instanceof bi)}function xi(e,t,n){if(!vu(n)||!function(s){return typeof s=="object"&&s!==null&&(Object.getPrototypeOf(s)===Object.prototype||Object.getPrototypeOf(s)===null)}(n)){const s=_i(n);throw s==="an object"?t._a(e+" a custom object"):t._a(e+" "+s)}}function Nr(e,t,n){if((t=Bt(t))instanceof Ls)return t._internalPath;if(typeof t=="string")return Ri(e,t);throw as("Field path arguments must be of type string or ",e,!1,void 0,n)}const Jg=new RegExp("[~\\*/\\[\\]]");function Ri(e,t,n){if(t.search(Jg)>=0)throw as(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`,e,!1,void 0,n);try{return new Ls(...t.split("."))._internalPath}catch{throw as(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,e,!1,void 0,n)}}function as(e,t,n,s,r){const i=s&&!s.isEmpty(),o=r!==void 0;let a=`Function ${t}() called with invalid data`;n&&(a+=" (via `toFirestore()`)"),a+=". ";let c="";return(i||o)&&(c+=" (found",i&&(c+=` in field ${s}`),o&&(c+=` in document ${r}`),c+=")"),new E(g.INVALID_ARGUMENT,a+e+c)}function wu(e,t){return e.some(n=>n.isEqual(t))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Eu{constructor(t,n,s,r,i){this._firestore=t,this._userDataWriter=n,this._key=s,this._document=r,this._converter=i}get id(){return this._key.path.lastSegment()}get ref(){return new pt(this._firestore,this._converter,this._key)}exists(){return this._document!==null}data(){if(this._document){if(this._converter){const t=new Zg(this._firestore,this._userDataWriter,this._key,this._document,null);return this._converter.fromFirestore(t)}return this._userDataWriter.convertValue(this._document.data.value)}}get(t){if(this._document){const n=this._document.data.field(Tu("DocumentSnapshot.get",t));if(n!==null)return this._userDataWriter.convertValue(n)}}}class Zg extends Eu{data(){return super.data()}}function Tu(e,t){return typeof t=="string"?Ri(e,t):t instanceof Ls?t._internalPath:t._delegate._internalPath}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ip(e){e=Pt(e,pt);const t=Pt(e.firestore,Re);return $g(Di(t),e._key).then(n=>hp(t,e,n))}class Su extends ep{constructor(t){super(),this.firestore=t}convertBytes(t){return new Ae(t)}convertReference(t){const n=this.convertDocumentKey(t,this.firestore._databaseId);return new pt(this.firestore,null,n)}}function op(e){e=Pt(e,Os);const t=Pt(e.firestore,Re),n=Di(t),s=new Su(t);return tp(e._query),Ug(n,e._query).then(r=>new sp(t,s,e,r))}function ap(e,t,n,...s){e=Pt(e,pt);const r=Pt(e.firestore,Re),i=mu(r);let o;return o=typeof(t=Bt(t))=="string"||t instanceof Ls?Xg(i,"updateDoc",e._key,t,n,s):Yg(i,"updateDoc",e._key,t),Mi(r,[o.toMutation(e._key,wt.exists(!0))])}function cp(e){return Mi(Pt(e.firestore,Re),[new li(e._key,wt.none())])}function up(e,t){const n=Pt(e.firestore,Re),s=du(e),r=np(e.converter,t);return Mi(n,[Wg(mu(e.firestore),"addDoc",s._key,r,e.converter!==null,{}).toMutation(s._key,wt.exists(!1))]).then(()=>s)}function Mi(e,t){return function(n,s){const r=new xt;return n.asyncQueue.enqueueAndForget(async()=>Ag(await Vg(n),s,r)),r.promise}(Di(e),t)}function hp(e,t,n){const s=n.docs.get(t._key),r=new Su(e);return new Iu(e,r,t._key,s,new Be(n.hasPendingWrites,n.fromCache),t.converter)}(function(e,t=!0){(function(n){ke=n})(jh),Gn(new Qe("firestore",(n,{instanceIdentifier:s,options:r})=>{const i=n.getProvider("app").getImmediate(),o=new Re(new cd(n.getProvider("auth-internal")),new dd(n.getProvider("app-check-internal")),function(a,c){if(!Object.prototype.hasOwnProperty.apply(a.options,["projectId"]))throw new E(g.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new an(a.options.projectId,c)}(i,s),i);return r=Object.assign({useFetchStreams:t},r),o._setSettings(r),o},"PUBLIC").setMultipleInstances(!0)),le(ao,"3.12.1",e),le(ao,"3.12.1","esm2017")})();var lp="firebase",dp="9.22.1";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */le(lp,dp,"app");const fp={apiKey:"AIzaSyDn-fBUWFaXmpn0-p7zhaAcH-IqalHAlmc",authDomain:"it-class-19dcf.firebaseapp.com",projectId:"it-class-19dcf",storageBucket:"it-class-19dcf.appspot.com",messagingSenderId:"1029514650420",appId:"1:1029514650420:web:a36d8302e23a1465203b61",measurementId:"G-6JEJK0T2NC"},gp=sa(fp),pp=Hg(gp),Oi=qg(pp,"secrets");async function mp(e){up(Oi,{text:e,complaints:0})}async function yp(){let e=(await op(Oi)).docs,t=e[Math.floor(Math.random()*e.length)],n=t.data();return{id:t.id,...n}}async function vp(e){let t=du(Oi,e.id),n=(await ip(t)).data().complaints+1;n<10?ap(t,{complaints:n}):cp(t)}function wp(e){let t,n,s,r,i,o,a,c,u,h,l;return{c(){t=J("div"),n=J("p"),s=bt("Det du skriver vil være anonymt for de som ser den."),r=me(),i=J("form"),o=J("input"),a=me(),c=J("button"),u=bt("Her er hemmeligheten min"),this.h()},l(d){t=Z(d,"DIV",{class:!0});var f=it(t);n=Z(f,"P",{class:!0});var y=it(n);s=kt(y,"Det du skriver vil være anonymt for de som ser den."),y.forEach(O),r=ye(f),i=Z(f,"FORM",{class:!0});var v=it(i);o=Z(v,"INPUT",{type:!0,placeholder:!0,class:!0}),a=ye(v),c=Z(v,"BUTTON",{type:!0,class:!0});var I=it(c);u=kt(I,"Her er hemmeligheten min"),I.forEach(O),v.forEach(O),f.forEach(O),this.h()},h(){st(n,"class","svelte-13h8o58"),st(o,"type","text"),st(o,"placeholder","Skriv hemmeligheten din her..."),o.required=!0,st(o,"class","svelte-13h8o58"),st(c,"type","submit"),st(c,"class","svelte-13h8o58"),st(i,"class","svelte-13h8o58"),st(t,"class","svelte-13h8o58")},m(d,f){Dt(d,t,f),V(t,n),V(n,s),V(t,r),V(t,i),V(i,o),Vi(o,e[0]),V(i,a),V(i,c),V(c,u),h||(l=[Un(o,"input",e[2]),Un(i,"submit",e[1])],h=!0)},p(d,[f]){f&1&&o.value!==d[0]&&Vi(o,d[0])},i:Ge,o:Ge,d(d){d&&O(t),h=!1,jo(l)}}}function Ep(e,t,n){const s=qo();let r="";function i(){s("submit",{secret:r}),n(0,r="")}function o(){r=this.value,n(0,r)}return[r,i,o]}class Tp extends xr{constructor(t){super(),Rr(this,t,Ep,wp,Mr,{})}}function Ip(e){let t,n,s,r,i,o,a,c,u,h;return{c(){t=J("p"),n=bt(e[0]),s=me(),r=J("button"),i=bt("Fortsett"),o=me(),a=J("button"),c=bt("Dårlig hemmelighet"),this.h()},l(l){t=Z(l,"P",{class:!0});var d=it(t);n=kt(d,e[0]),d.forEach(O),s=ye(l),r=Z(l,"BUTTON",{class:!0});var f=it(r);i=kt(f,"Fortsett"),f.forEach(O),o=ye(l),a=Z(l,"BUTTON",{class:!0});var y=it(a);c=kt(y,"Dårlig hemmelighet"),y.forEach(O),this.h()},h(){st(t,"class","svelte-rvecav"),st(r,"class","continue svelte-rvecav"),st(a,"class","complain svelte-rvecav")},m(l,d){Dt(l,t,d),V(t,n),Dt(l,s,d),Dt(l,r,d),V(r,i),Dt(l,o,d),Dt(l,a,d),V(a,c),u||(h=[Un(r,"click",e[1]),Un(a,"click",e[2])],u=!0)},p(l,[d]){d&1&&Cu(n,l[0])},i:Ge,o:Ge,d(l){l&&O(t),l&&O(s),l&&O(r),l&&O(o),l&&O(a),u=!1,jo(h)}}}function Sp(e,t,n){let{secret:s=""}=t;const r=qo();function i(){r("reset")}function o(){r("complain")}return e.$$set=a=>{"secret"in a&&n(0,s=a.secret)},[s,i,o]}class Cp extends xr{constructor(t){super(),Rr(this,t,Sp,Ip,Mr,{secret:0})}}function Ap(e){let t,n,s,r;return n=new Tp({}),n.$on("submit",e[1]),{c(){t=J("div"),zo(n.$$.fragment),this.h()},l(i){t=Z(i,"DIV",{class:!0});var o=it(t);Ho(n.$$.fragment,o),o.forEach(O),this.h()},h(){st(t,"class","content svelte-i7oa22")},m(i,o){Dt(i,t,o),Ko(n,t,null),r=!0},p:Ge,i(i){r||(jn(n.$$.fragment,i),Go(()=>{r&&(s||(s=qn(t,zn,{x:"-100%",duration:300},!0)),s.run(1))}),r=!0)},o(i){Bn(n.$$.fragment,i),s||(s=qn(t,zn,{x:"-100%",duration:300},!1)),s.run(0),r=!1},d(i){i&&O(t),Qo(n),i&&s&&s.end()}}}function _p(e){let t,n,s,r;return n=new Cp({props:{secret:e[0].text}}),n.$on("reset",e[3]),n.$on("complain",e[2]),{c(){t=J("div"),zo(n.$$.fragment),this.h()},l(i){t=Z(i,"DIV",{class:!0});var o=it(t);Ho(n.$$.fragment,o),o.forEach(O),this.h()},h(){st(t,"class","content svelte-i7oa22")},m(i,o){Dt(i,t,o),Ko(n,t,null),r=!0},p(i,o){const a={};o&1&&(a.secret=i[0].text),n.$set(a)},i(i){r||(jn(n.$$.fragment,i),Go(()=>{r&&(s||(s=qn(t,zn,{x:"100%",duration:300},!0)),s.run(1))}),r=!0)},o(i){Bn(n.$$.fragment,i),s||(s=qn(t,zn,{x:"100%",duration:300},!1)),s.run(0),r=!1},d(i){i&&O(t),Qo(n),i&&s&&s.end()}}}function Dp(e){let t,n,s,r,i,o,a,c,u,h,l,d,f,y,v,I;const B=[_p,Ap],R=[];function W(M,Y){return M[0]!==void 0?0:1}return y=W(e),v=R[y]=B[y](e),{c(){t=J("main"),n=J("header"),s=J("h1"),r=bt("Hemmeligheter"),i=me(),o=J("h3"),a=J("span"),c=bt("Gi en Hemmelighet"),u=bt(`,\r
      `),h=J("span"),l=bt("Få en Hemmelighet!"),d=me(),f=J("div"),v.c(),this.h()},l(M){t=Z(M,"MAIN",{class:!0});var Y=it(t);n=Z(Y,"HEADER",{class:!0});var yt=it(n);s=Z(yt,"H1",{});var Me=it(s);r=kt(Me,"Hemmeligheter"),Me.forEach(O),i=ye(yt),o=Z(yt,"H3",{});var oe=it(o);a=Z(oe,"SPAN",{});var Oe=it(a);c=kt(Oe,"Gi en Hemmelighet"),Oe.forEach(O),u=kt(oe,`,\r
      `),h=Z(oe,"SPAN",{});var Li=it(h);l=kt(Li,"Få en Hemmelighet!"),Li.forEach(O),oe.forEach(O),yt.forEach(O),d=ye(Y),f=Z(Y,"DIV",{class:!0});var Pi=it(f);v.l(Pi),Pi.forEach(O),Y.forEach(O),this.h()},h(){_n(a,"color",e[0]===void 0?"#FB4934":""),_n(h,"color",e[0]!==void 0?"#689D6A":""),st(n,"class","svelte-i7oa22"),st(f,"class","wrapper svelte-i7oa22"),st(t,"class","svelte-i7oa22")},m(M,Y){Dt(M,t,Y),V(t,n),V(n,s),V(s,r),V(n,i),V(n,o),V(o,a),V(a,c),V(o,u),V(o,h),V(h,l),V(t,d),V(t,f),R[y].m(f,null),I=!0},p(M,[Y]){Y&1&&_n(a,"color",M[0]===void 0?"#FB4934":""),Y&1&&_n(h,"color",M[0]!==void 0?"#689D6A":"");let yt=y;y=W(M),y===yt?R[y].p(M,Y):(_u(),Bn(R[yt],1,1,()=>{R[yt]=null}),Au(),v=R[y],v?v.p(M,Y):(v=R[y]=B[y](M),v.c()),jn(v,1),v.m(f,null))},i(M){I||(jn(v),I=!0)},o(M){Bn(v),I=!1},d(M){M&&O(t),R[y].d()}}}function bp(e,t,n){let s;async function r(a){if(n(0,s=await yp()),console.log(s),a.detail.secret=="skip"){console.log("Skipping submission");return}mp(a.detail.secret)}async function i(){vp(s),o()}function o(){n(0,s=void 0)}return[s,r,i,o]}class Np extends xr{constructor(t){super(),Rr(this,t,bp,Dp,Mr,{})}}export{Np as component};
